...
Rtools does not put itself on the PATH. You can add the following line to your `~/.Renviron` file (where `~` is your home directory) help R find rtools when installing packages.
